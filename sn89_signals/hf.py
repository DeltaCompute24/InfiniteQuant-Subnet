...
# re-measure off the corpus once it holds a week of them.
# 2026-09-09 (later): every market the tick bus serves from Hyperliquid — main-dex
# perps and the builder DEXs (equities, indices, metals, commodities) at >= $100k/24h
# and OI > 0 — with sigma as the same statistic off HL 5-minute candles over the
# trailing 7 days (>= 200 candles required). Equities follow SN8: PTN's market
# calendar is open for any HL-sourced pair at any hour, so these are callable
# around the clock and graded on the HL mark. Classes beyond the board's three
# (metals, commodities, indices, equities) grid at 250 ms like crypto: the feed is
# HL's, which timestamps to the millisecond. A pair that is ALSO on the HF board keeps the sigma derived from
...
HF_CUSTOM_UNIVERSE_V1 = {
    "0GUSD": ("crypto", 2.1013),
    "10YUSD": ("equities", 0.6628),
    "2ZUSD": ("crypto", 1.3206),
    "AAOIUSD": ("equities", 1.4521),
    "AAPLUSD": ("equities", 0.3432),
    "AAVEUSD": ("crypto", 1.1775),
    "ACEUSD": ("crypto", 2.7135),
    "ADAUSD": ("crypto", 1.4908),
    "AEROUSD": ("crypto", 2.1845),
    "AIXBTUSD": ("crypto", 1.8655),
    "ALGOUSD": ("crypto", 1.6303),
    "AMATUSD": ("equities", 0.7440),
    "AMDUSD": ("equities", 0.7555),
    "AMZNUSD": ("equities", 0.3805),
    "ANIMEUSD": ("crypto", 1.2489),
    "ANSEMUSD": ("equities", 6.2007),
    "ANTHUSD": ("equities", 1.0428),
    "APEUSD": ("crypto", 1.1813),
    "APEXUSD": ("crypto", 3.6175),
    "APTUSD": ("crypto", 1.7885),
    "ARBUSD": ("crypto", 2.7757),
    "ARMUSD": ("equities", 1.0055),
    "ARUSD": ("crypto", 2.3917),
    "ASMLUSD": ("equities", 0.6264),
    "ASTERUSD": ("crypto", 1.6233),
    "ATOMUSD": ("crypto", 1.3354),
    "AUDCAD": ("forex", 0.1706),
    "AUDCHF": ("forex", 0.3324),
    "AUDJPY": ("forex", 0.2517),
    "AUDNZD": ("forex", 0.1258),
    ...
    "AVGOUSD": ("equities", 1.4007),
    "AVNTUSD": ("crypto", 1.8753),
    "AXSUSD": ("crypto", 1.0255),
    "AZTECUSD": ("crypto", 2.5139),
    "BABAUSD": ("equities", 0.5707),
    "BABYUSD": ("crypto", 1.2289),
    "BBUSD": ("equities", 0.7904),
    "BCHUSD": ("crypto", 1.3558),
    "BERAUSD": ("crypto", 1.4325),
    "BEUSD": ("equities", 1.8785),
    "BIOUSD": ("crypto", 1.4618),
    "BMNRUSD": ("equities", 1.6028),
    "BNBUSD": ("crypto", 0.6935),
    "BOMEUSD": ("crypto", 2.3650),
    "BOTUSD": ("equities", 1.1137),
    "BRENTUSD": ("commodities", 0.6335),
    "BRETTUSD": ("crypto", 1.8262),
    "BSVUSD": ("crypto", 1.0422),
    "BTCDUSD": ("equities", 0.1395),
    "BTCUSD": ("crypto", 0.5934),
    "BXUSD": ("equities", 0.7047),
    "CADCHF": ("forex", 0.3863),
    "CADJPY": ("forex", 0.2704),
    "CAKEUSD": ("crypto", 1.6999),
    "CASHCATUSD": ("crypto", 5.9731),
    "CBRSUSD": ("equities", 1.5216),
    "CCUSD": ("crypto", 1.3526),
    "CELOUSD": ("crypto", 1.3649),
    "CFXUSD": ("crypto", 1.1301),
    "CHFJPY": ("forex", 0.2560),
    "CHIPUSD": ("crypto", 3.7806),
    "COHRUSD": ("equities", 1.4209),
    "COINUSD": ("equities", 1.0400),
    "COMPUSD": ("crypto", 1.3035),
    "COPPERUSD": ("metals", 0.3669),
    "COSTUSD": ("equities", 0.3966),
    "CRCLUSD": ("equities", 1.3637),
    "CRDOUSD": ("equities", 1.6861),
    "CRVUSD": ("crypto", 1.7441),
    "CRWDUSD": ("equities", 0.8999),
    "CRWVUSD": ("equities", 1.1153),
    "CXMTUSD": ("equities", 0.9010),
    "DASHUSD": ("crypto", 3.3755),
    "DELLUSD": ("equities", 1.3855),
    "DOGEUSD": ("crypto", 1.1486),
    "DOTUSD": ("crypto", 2.5515),
    "DRAMUSD": ("equities", 0.9391),
    "DYDXUSD": ("crypto", 1.5111),
    "DYMUSD": ("crypto", 1.0163),
    "EBAYUSD": ("equities", 0.8008),
    "EIGENUSD": ("crypto", 1.8525),
    "ENAUSD": ("crypto", 1.7801),
    "ENSUSD": ("crypto", 1.9552),
    "ETCUSD": ("crypto", 1.5002),
    "ETHFIUSD": ("crypto", 1.9818),
    ...
    "EURNZD": ("forex", 0.1697),
    "EURUSD": ("forex", 0.1040),
    "EWJUSD": ("indices", 0.4169),
    "EWTUSD": ("indices", 0.4199),
    "EWYUSD": ("indices", 0.6974),
    "EWZUSD": ("indices", 0.7702),
    "FARTCOINUSD": ("crypto", 2.2889),
    "FETUSD": ("crypto", 1.7991),
    "FILUSD": ("crypto", 1.6869),
    "FOGOUSD": ("crypto", 1.1355),
    "GALAUSD": ("crypto", 1.6866),
    "GBPAUD": ("forex", 0.1120),
    "GBPCAD": ("forex", 0.0982),
    "GBPCHF": ("forex", 0.1466),
    "GBPJPY": ("forex", 0.2239),
    "GBPNZD": ("forex", 0.2118),
    "GBPUSD": ("forex", 0.1122),
    "GEVUSD": ("equities", 0.7599),
    "GIGADEVUSD": ("equities", 1.1507),
    "GLWUSD": ("equities", 1.0899),
    "GMEUSD": ("equities", 0.7120),
    "GMXUSD": ("crypto", 1.4807),
    "GOATUSD": ("crypto", 2.0050),
    "GOOGLUSD": ("equities", 0.3746),
    "GPROUSD": ("equities", 5.9854),
    "GRAMUSD": ("crypto", 0.9710),
    "GRASSUSD": ("crypto", 1.6097),
    "HBARUSD": ("crypto", 1.0257),
    "HEMIUSD": ("crypto", 6.3866),
    "HIMSUSD": ("equities", 0.9121),
    "HOODUSD": ("equities", 1.3202),
    "HYPERUSD": ("crypto", 1.1934),
    "HYPEUSD": ("crypto", 1.1227),
    "HYUNDAIUSD": ("equities", 0.6386),
    "IBMUSD": ("equities", 0.5018),
    "ICPUSD": ("crypto", 1.8860),
    "IMXUSD": ("crypto", 1.3607),
    "INJUSD": ("crypto", 1.9344),
    "INTCUSD": ("equities", 1.0060),
    "IOTAUSD": ("crypto", 1.4689),
    "IOUSD": ("crypto", 1.4485),
    "IRENUSD": ("equities", 1.3019),
    "JP225USD": ("indices", 0.6800),
    "JTOUSD": ("crypto", 2.0579),
    "JUPUSD": ("crypto", 2.2982),
    "KAITOUSD": ("crypto", 1.2783),
    "KASUSD": ("crypto", 1.8864),
    "KBONKUSD": ("crypto", 2.0180),
    "KFLOKIUSD": ("crypto", 1.5344),
    "KIOXIAUSD": ("equities", 1.2711),
    "KLUNCUSD": ("crypto", 1.2584),
    "KORUUSD": ("indices", 2.0509),
    "KPEPEUSD": ("crypto", 1.4609),
    "KR200USD": ("indices", 0.8882),
    "KSHIBUSD": ("crypto", 1.1390),
    "LDOUSD": ("crypto", 1.7676),
    "LINEAUSD": ("crypto", 1.2409),
    "LINKUSD": ("crypto", 1.3108),
    "LITEUSD": ("equities", 1.3023),
    "LITUSD": ("crypto", 2.6596),
    "LLYUSD": ("equities", 0.4911),
    "LRCXUSD": ("equities", 1.6454),
    "LTCUSD": ("crypto", 1.2951),
    "LYTEUSD": ("equities", 0.9392),
    "MANTAUSD": ("crypto", 1.1363),
    "MEGAUSD": ("crypto", 1.8705),
    "MELANIAUSD": ("crypto", 1.9277),
    "MEMEUSD": ("crypto", 1.4328),
    "METAUSD": ("equities", 0.6388),
    "METUSD": ("crypto", 2.3659),
    "MINAUSD": ("crypto", 1.9658),
    "MINIMAXUSD": ("equities", 1.9690),
    "MNTUSD": ("crypto", 1.2759),
    "MONUSD": ("crypto", 2.1991),
    "MOODENGUSD": ("crypto", 1.9840),
    "MORPHOUSD": ("crypto", 1.6931),
    "MOVEUSD": ("crypto", 1.5963),
    "MRNAUSD": ("equities", 1.3973),
    "MRVLUSD": ("equities", 1.0247),
    "MSFTUSD": ("equities", 0.4141),
    "MSTRUSD": ("equities", 1.2450),
    "MUUSD": ("equities", 1.0472),
    "NATGASUSD": ("commodities", 0.7042),
    "NBISUSD": ("equities", 1.3452),
    "NCLDUSD": ("equities", 1.3992),
    "NEARUSD": ("crypto", 2.1247),
    "NEOUSD": ("crypto", 0.9851),
    "NETUSD": ("equities", 0.8495),
    "NFLXUSD": ("equities", 0.5329),
    "NILUSD": ("crypto", 1.8300),
    "NOKUSD": ("equities", 0.8943),
    "NOWUSD": ("equities", 1.0218),
    "NVDAUSD": ("equities", 0.4884),
    "NXPCUSD": ("crypto", 1.0450),
    "NZDCAD": ("forex", 0.2341),
    "NZDCHF": ("forex", 0.1619),
    "NZDJPY": ("forex", 0.2556),
    "NZDUSD": ("forex", 0.1964),
    "OAIUSD": ("equities", 2.1010),
    "ONDOUSD": ("crypto", 1.4359),
    "OPUSD": ("crypto", 2.0038),
    "ORCLUSD": ("equities", 0.8272),
    "ORDIUSD": ("crypto", 1.6522),
    "PALLADIUMUSD": ("metals", 0.6465),
    "PAXGUSD": ("metals", 0.4020),
    "PENDLEUSD": ("crypto", 1.8138),
    "PENGUUSD": ("crypto", 1.7272),
    "PEOPLEUSD": ("crypto", 1.5573),
    "PLATINUMUSD": ("metals", 0.5916),
    "PLTRUSD": ("equities", 0.8359),
    "PNUTUSD": ("crypto", 1.5089),
    "POLUSD": ("crypto", 1.2766),
    "POLYXUSD": ("crypto", 1.3195),
    "PONSUSD": ("crypto", 6.8295),
    "POPCATUSD": ("crypto", 1.4368),
    "PROVEUSD": ("crypto", 1.1163),
    "PUMPUSD": ("crypto", 2.8872),
    "PURRDATUSD": ("equities", 2.1602),
    "PURRUSD": ("crypto", 2.3656),
    "PYTHUSD": ("crypto", 1.8416),
    "QCOMUSD": ("equities", 1.2249),
    "QNTUSD": ("equities", 1.1911),
    "RDDTUSD": ("equities", 0.9588),
    "RENDERUSD": ("crypto", 1.4709),
    "RESOLVUSD": ("crypto", 1.3161),
    "REZUSD": ("crypto", 1.5648),
    "RIVNUSD": ("equities", 0.7382),
    "RKLBUSD": ("equities", 1.0251),
    "RUNEUSD": ("crypto", 0.9238),
    "SANDUSD": ("crypto", 1.1872),
    "SEIUSD": ("crypto", 1.4292),
    "SHAZUSD": ("equities", 1.7456),
    "SHEINUSD": ("equities", 1.6203),
    "SKHXUSD": ("equities", 1.1091),
    "SKHYUSD": ("equities", 1.0042),
    "SKRUSD": ("crypto", 4.5349),
    "SKYUSD": ("crypto", 1.1146),
    "SMALL2000USD": ("equities", 0.3784),
    "SMHUSD": ("indices", 0.5650),
    "SMSNUSD": ("equities", 0.9656),
    "SNDKUSD": ("equities", 1.2338),
    "SOFTBANKUSD": ("equities", 2.0982),
    "SOLUSD": ("crypto", 1.0015),
    "SOPHUSD": ("crypto", 6.7736),
    "SOXLUSD": ("indices", 1.7897),
    "SP500USD": ("indices", 0.1561),
    "SPCXUSD": ("equities", 0.8542),
    "SPXUSD": ("crypto", 2.1718),
    "STABLEUSD": ("crypto", 0.9878),
    "STBLUSD": ("crypto", 1.2841),
    "STRCUSD": ("equities", 0.1771),
    "STRKUSD": ("crypto", 2.0203),
    "STXUSD": ("crypto", 1.5949),
    "SUIUSD": ("crypto", 1.6961),
    "SUPERUSD": ("crypto", 1.2526),
    "SUSD": ("crypto", 1.6829),
    "SUSHIUSD": ("crypto", 2.8343),
    "SYRUPUSD": ("crypto", 1.8504),
    "TAOUSD": ("crypto", 1.8260),
    "TIAUSD": ("crypto", 2.0657),
    "TOTAL2USD": ("equities", 1.0609),
    "TRUMPUSD": ("crypto", 1.9954),
    "TRXUSD": ("crypto", 0.2759),
    "TSLAUSD": ("equities", 0.7258),
    "TSMUSD": ("equities", 0.4759),
    "UMAUSD": ("crypto", 1.1336),
    "UNITREEUSD": ("equities", 0.7720),
    "UNIUSD": ("crypto", 1.8614),
    "URNMUSD": ("indices", 0.7516),
    "US500USD": ("equities", 0.1166),
    "USARUSD": ("equities", 1.2001),
    "USBONDUSD": ("equities", 0.2156),
    "USDCAD": ("forex", 0.1211),
    "USDCHF": ("forex", 0.1697),
    "USDJPY": ("forex", 0.2836),
    "USTECHUSD": ("equities", 0.2295),
    "USUALUSD": ("crypto", 1.4072),
    "VIRTUALUSD": ("crypto", 1.7305),
    "VSTUSD": ("equities", 1.2808),
    "VVVUSD": ("crypto", 3.0129),
    "WDCUSD": ("equities", 1.1995),
    "WIFUSD": ("crypto", 1.7093),
    "WLDUSD": ("crypto", 2.7265),
    "WLFIUSD": ("crypto", 0.8492),
    "WTIUSD": ("commodities", 0.6762),
    "WUSD": ("crypto", 1.5182),
    "XAGUSD": ("forex-commodities", 0.6831),
    "XAUUSD": ("forex-commodities", 0.4338),
    "XLEUSD": ("indices", 0.4763),
    "XLMUSD": ("crypto", 1.2134),
    "XMRUSD": ("crypto", 1.6972),
    "XPLUSD": ("crypto", 2.3971),
    "XRPUSD": ("crypto", 1.1203),
    "XYZ100USD": ("indices", 0.2441),
    "YGGUSD": ("crypto", 1.5898),
    "ZECUSD": ("crypto", 1.9331),
    "ZENUSD": ("crypto", 2.9707),
    "ZETAUSD": ("crypto", 1.2257),
    "ZHIPUUSD": ("equities", 1.3408),
    "ZKUSD": ("crypto", 1.8480),
    "ZMUSD": ("equities", 0.8233),
    "ZORAUSD": ("crypto", 3.0095),
...
GRID_MS_BY_CLASS = {
    ...
    # HL-sourced classes (custom universe only): millisecond feed, crypto grid.
    "metals": 250,
    "commodities": 250,
    "indices": 250,
    "equities": 250,
